  ...
  return (
    ...
    >
      <LiquidGlass className="border border-blue-600/30 min-h-[345px]">
        <div
          className="relative p-6 md:p-8 rounded-3xl overflow-hidden h-full"
          style={{
            backgroundImage:
              "radial-gradient(circle at 50% 50%, rgba(30, 64, 175, 0.1) 1px, transparent 1px)",
  ...
  return (
    <section className="py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <LiquidGlass className="px-12 py-2 text-white mb-4 inline-block">
            Happy Faces
          </LiquidGlass>
